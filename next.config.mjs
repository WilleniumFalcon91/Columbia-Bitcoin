        ...
        headers: [
          {
            ...
            value: [
              ...
              "img-src 'self' https://img.youtube.com https://raw.githubusercontent.com https://*.tile.openstreetmap.org data: blob:",
              ...
              "connect-src 'self' https://api.coingecko.com https://formspree.io https://www.google-analytics.com https://region1.google-analytics.com https://region1.analytics.google.com https://stats.g.doubleclick.net https://vitals.vercel-insights.com",
              "object-src 'none'",
              "base-uri 'self'",
            ].join("; "),
          },
